...
public class UserServLet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else if(request.getParameter("tbl").equals("userlogin")){
            request.getRequestDispatcher("/WEB-INF/userlogin.jsp").forward(request, response);    
        }
        else if(request.getParameter("tbl").equals("Registor")){
            request.getRequestDispatcher("/WEB-INF/Registor.jsp").forward(request, response);    
        }
        else {
